...
DATABASE_URL1 = "mysql://admin:Seigakushakorea0308(!@57.180.41.44/boardDB1_lhi11"
DATABASE_URL2 = "mysql://admin:Seigakushakorea0308(!@57.180.41.44/boardDB2_lhi11"
DATABASE_URL3 = "mysql://admin:Seigakushakorea0308(!@57.180.41.44/boardDB3_lhi11"
...
# html과 css, js파일을 서버에서 열기 위한 작업(http server와 fastapi를 동시에 돌리면 기능이 작동 안하기도 함)
# / 로 index.html에 접근할 수 있도록 설정
...
@app.get("/index.css")
async def read_css():
    return FileResponse(Path("index.css"))  # index.css 파일 반환

@app.get("/script.js")
async def read_script():
    return FileResponse(Path("script.js"))  # script.js 파일 반환
